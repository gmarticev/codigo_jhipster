...
import es.curso.jhipster.domain.Categoria;
import es.curso.jhipster.repository.CategoriaRepository;
...
/**
 * REST controller for managing {@link es.curso.jhipster.domain.Categoria}.
 */
@RestController
@RequestMapping("/api")
@Transactional
